...
class VariablesTestCase(unittest.TestCase):
    ...
    def test_read_arguments(self):
        ...
        self.debugger.cmd(
            "arg box_arr", "box_arr = alloc::boxed::Box<[u8], alloc::alloc::Global> {"
        )
        self.debugger.cmd(
            "arg all",
            "by_val = i32(1)",
    ...
    def test_address(self):
        ...
        self.debugger.cmd("continue", "let nop: Option<u8> = None;")
        self.debugger.cmd_re(
            "var &hm6[{field_1: 1, field_2: *, field_3: *}]", r"&i32 \[0x[0-9A-F]{14}\]"
        )
    ...
    def test_read_time(self):
        ...
        self.debugger.cmd("run", "let nop: Option<u8> = None;")
        self.debugger.cmd(
            "var system_time", "system_time = SystemTime(1970-01-01 00:00:00)"
        )
        self.debugger.cmd_re(
            "var instant", r"instant = Instant\(\d+ seconds from now\)"
        )
