...
class FunctionCallTestCase(unittest.TestCase):
    ...
    def test_six_args(self):
        ...
        self.debugger.cmd(
            "call sum6i 1 256 65537 4294967297 4294967297 -1", "my sum is 8590000387"
        )
        self.debugger.cmd("call sum6u 1 2 3 4 5 6", "my sum is 21")
        self.debugger.cmd(
            "call sum6u 1 256 65537 4294967297 4294967297 1", "my sum is 8590000389"
        )
    ...
    def test_pointer_arg(self):
        ...
        self.debugger.cmd(
            "call print_deref " + addr1 + " " + addr2 + " " + addr3,
            'deref is 100 101 Foo { bar: 102, baz: "103" }',
        )
