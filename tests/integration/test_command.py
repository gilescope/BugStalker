...
class CommandTestCase(unittest.TestCase):
    ...
    def test_multiple_breakpoints_set(self):
        ...
        self.debugger.cmd(
            "continue", "Hello, world!", "Hit breakpoint 2 at", 'myprint("bye!")'
        )
        self.debugger.cmd("continue", "bye!")
    ...
    def test_step_in():
        ...
        debugger = Debugger(
            path="./examples/target/debug/calc -- 1 2 3 --description result"
        )
    ...
    def test_get_symbol(self):
        ...
        self.debugger.cmd_re(
            "symbol main", "__libc_start_main", r"main - Text 0x[0-9A-F]{,16}"
        )
    ...
    def test_args_for_executable():
        ...
        debugger = Debugger(
            path="./examples/target/debug/calc -- 1 1 1 --description three"
        )
    ...
    def test_disasm(self):
        ...
        self.debugger.cmd("run")
        self.debugger.cmd(
            "source asm", "Assembler code for function hello_world::main", "mov"
        )
        self.debugger.cmd("break myprint", "New breakpoint")
        self.debugger.cmd("continue")
        self.debugger.cmd(
            "source asm", "Assembler code for function hello_world::myprint", "mov"
        )
