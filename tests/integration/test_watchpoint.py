...
class WatchpointTestCase(unittest.TestCase):
    ...
    def test_watchpoint(self):
        ...
        self.debugger.cmd(
            "continue", "Watchpoint 1 (expr: c) end of scope", "old value: u64(1)"
        )
    ...
    def test_watchpoint_rw(self):
        ...
        self.debugger.cmd(
            "continue", "Hit watchpoint 1 (expr: a) (rw)", "value: u64(1)"
        )
        self.debugger.cmd(
            "continue",
        ...
        self.debugger.cmd(
            "continue", "Hit watchpoint 1 (expr: a) (rw)", "value: u64(6)"
        )
        self.debugger.cmd(
            "continue", "Watchpoint 1 (expr: a) end of scope", "old value: u64(6)"
        )
