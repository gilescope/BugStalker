...
class SignalsTestCase(unittest.TestCase):
    def test_signal_stop_single_thread(self):
        ...
        self.debugger = Debugger(
            path="./examples/target/debug/signals -- single_thread"
        )
    ...
    def test_multi_thread_multi_signal(self):
        ...
        self.debugger = Debugger(
            path="./examples/target/debug/signals -- multi_thread_multi_signal"
        )
        ...
        self.debugger.expect_in_output_re(
            r"Signal SIGUSR[1,2]{1} received, debugee stopped"
        )
        self.debugger.cmd_re(
            "continue", "Signal SIGUSR[1,2]{1} received, debugee stopped"
        )
        self.debugger.cmd("continue", "threads join")
